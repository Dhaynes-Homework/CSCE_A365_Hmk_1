...
# For use in CSCE A365 Homework assignment 1
# Needs client.py and tftp.py to function
# Won't work without the server to respond

# Purpose is to create a tftp client to read and write to a tftp server
